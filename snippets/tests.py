...
from snippets.views import top, snippet_new, snippet_edit, snippet_edit, snippet_detail
...
class SnippetDetailTest(TestCase):
    ...
    def test_page_returns_200_and_expected_heading(self):
        response = self.client.get("/snippets/%s/" % self.snippet.id)
        self.assertContains(response, self.snippet.title, status_code=200)
       
class EditSnippetlTest(TestCase):
